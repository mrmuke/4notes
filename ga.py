...
#genome_1 = generate_genome(5)
#genome_2=generate_genome(5)
#print(genome_1)
#print(genome_2)
#print(single_point_crossover(genome_1,genome_2))
#print(mutation(genome_1))
#population = [genome_1,genome_2]
#def fitness(genome:Genome):
#    return 0
#print(selection_pair(population,fitness))